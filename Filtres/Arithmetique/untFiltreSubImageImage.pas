...
type
  TfrmFiltreSubImageImage = class(TfrmHFiltreImageImage)
...
var
  frmFiltreSubImageImage: TfrmFiltreSubImageImage;
...
{ TfrmFiltreSubImageImage }

procedure TfrmFiltreSubImageImage.PrevisualiseResultat;
var
  X, Y : Integer;
  X2, Y2 : Integer;
begin
...
begin
  ...
  begin
    ...
    begin
      ImageResultat.Image[X, Y].Rouge := Image1.Image[X, Y].Rouge - Image2.Image[X, Y].Rouge;  // Soustrait
...
procedure TfrmFiltreSubImageImage.btnOKClick(Sender: TObject);
begin
  inherited;
