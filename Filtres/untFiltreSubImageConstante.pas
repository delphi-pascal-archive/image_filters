unit untFiltreSubImageConstante;
...
type
  TfrmFiltreSubImageConstante = class(TfrmHFiltreImageConstante)
...
var
  frmFiltreSubImageConstante: TfrmFiltreSubImageConstante;
...
{ TfrmFiltreSubImageConstante }

procedure TfrmFiltreSubImageConstante.PrevisualiseResultat;
var
  X, Y : Integer;
  X2, Y2 : Integer;
begin
...
begin
  ...
  begin
    ...
    begin
      ImageResultat.Image[X, Y].Rouge := Image.Image[X, Y].Rouge - Couleur.Rouge;  // Soustrait
...
procedure TfrmFiltreSubImageConstante.btnOKClick(Sender: TObject);
begin
  inherited;
